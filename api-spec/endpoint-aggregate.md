...
| `operations[].field` | string | Ya | — | Nama field atau `"*"` (hanya untuk `count`) |
...
| `having[].field` | string | Ya | — | Nama field atau `"*"` |
...
| `fields` | array | Kolom yang tersedia untuk `group_by` dan `select` |
