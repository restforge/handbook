...
Primary key header dan setiap detail item di-generate otomatis sebagai UUID. Foreign key di detail items otomatis diisi dari primary key header. Field kalkulasi (total per baris, total header) dihitung otomatis berdasarkan konfigurasi.
...
- Field yang di-auto-calculate **tidak perlu dikirim**
...
## Field Otomatis (Auto-Generated & Auto-Calculated Fields)
...
### Field yang Di-calculate (Detail Level)
...
### Field yang Di-calculate (Header Level)
