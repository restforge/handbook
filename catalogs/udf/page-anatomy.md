...
| Properti | Tipe | Default | Wajib | Keterangan |
|----------|------|---------|:-----:|-----------|
| `details` | array | — | ✗ | Array detail table untuk pola master-detail. Lihat [`master-detail.md`](./master-detail.md) |
...
| Konflik dengan `navigation` | Jika `navigation` ada di root, `pageGroup` di-ignore (validator menghasilkan warning) |
