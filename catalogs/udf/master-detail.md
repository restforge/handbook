...
> Pola halaman master-detail: satu page CRUD memiliki satu atau lebih detail table yang terkait.
...
UDF mendeklarasikan detail di field `details[]` di page object master. Setiap entry di `details[]` mendefinisikan satu table detail.
...
Satu master dapat memiliki beberapa detail table:
...
Setiap detail di-render sebagai section terpisah di form master.
