...
Jika kedua mekanisme ada (blok `navigation` ada DAN ada `pageGroup` di page), validator menghasilkan warning bahwa `pageGroup` akan di-ignore.
...
| `form` | Warning: sidebar akan di-filter runtime berdasarkan file output yang ada |
