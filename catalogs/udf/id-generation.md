...
Beberapa field membutuhkan nilai yang di-generate secara otomatis di backend (mis. nomor invoice berurutan, kode unik per tahun). UDF menyediakan pola `defaultValue.source: "idgen"` untuk mendeklarasikan kebutuhan ini secara deklaratif tanpa menulis logic JavaScript.
