...
## Kapan Pakai Mana (When to Use Which)
...
| Mengonversi RDF ke UI default untuk speed-up UI development | UDF (di-konversi dari RDF) |

## Alur Hubungan (Format Flow)

![Definition File Flow](https://pub-6096676046da426597041567e928006f.r2.dev/handbook/definition-file.png)

Setiap format dapat ditulis manual atau di-generate dari format sebelumnya untuk konsistensi nama field.

## Versi Schema (Schema Version)
...
Konsumer catalog (MCP server, LSP, AI agent) wajib cek `schemaVersion` sebelum parsing.
