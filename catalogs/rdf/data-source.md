...
| Item | Perilaku |
|------|----------|
| Nama kolom | Search hanya pada kolom tersebut (jika `search_by` di request cocok) |
...
Detail per dialect dan interaksi dengan `fieldValidation.constraints.format` dibahas di dokumentasi terpisah untuk fitur create, bagian "Date Parsing".
