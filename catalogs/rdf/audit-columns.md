...
|-------|-------------------|----------|
| Tidak ditetapkan (default) | Runtime mengisi `created_at`, `created_by`, `updated_at`, `updated_by` secara otomatis saat INSERT/UPDATE | Tabel mengikuti konvensi audit standar RESTForge |
