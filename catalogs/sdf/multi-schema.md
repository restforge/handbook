...
| Aturan | Penjelasan |
|--------|-----------|
| Default value | Bila `schema` tidak ditetapkan, tabel masuk ke default schema (PostgreSQL: `public`, Oracle: schema user, MySQL: database aktif) |
...
| Folder layout introspect | Saat introspect database multi-schema, output file disusun per schema dalam subfolder `<output>/<schema>/<table>.js` |

**Contoh cross-schema reference:**
