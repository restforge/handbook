...
| `onUpdate` | `cascade`, `restrict`, `setNull`, `noAction` | (tidak ditetapkan) | Behavior saat parent di-update. Bila tidak ditetapkan, DDL skip clause `ON UPDATE`, database pakai default-nya |
