# Definisi Composite Primary Key (Composite Primary Key Definition)
...
3. Field di `primaryKey` harus exist di property `fields`, jika tidak validator akan throw error
