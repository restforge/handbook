...
| `distributedLock.infoMessage` | string | `""` | Pesan informasi saat halaman dibuka. Placeholder `{ttl}` diganti secara otomatis dengan durasi terformat. Kosong berarti pesan tidak ditampilkan |
