...
- Sesuaikan `LOCK_DISTRIBUTED_TTL` dengan durasi query database terlama. Apabila query memerlukan 5 detik, tetapkan TTL minimal 10 detik
- Monitor log `write_lock_timeout` dan `write_lock_waiting` untuk mendeteksi contention pada record tertentu
