...
| `codegen_create_endpoint`, `codegen_create_dashboard` | `--force=true` selama parameter `force` dibiarkan pada default `true` | File modul lama ditimpa; CLI mengarsipkan versi sebelumnya ke `.restforge/archive/<YYYYMMDD-HHMMSS>/` |
