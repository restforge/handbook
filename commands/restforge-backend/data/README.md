...
## Prasyarat SDF (SDF Prerequisite)
...
## Resolusi Config (Config Resolution)
...
### Representasi Nilai (Value Representation)
...
## Penanganan Lintas-Dialect (Cross-Dialect)
...
SQLite/Oracle) ditangani otomatis saat push.
...
### Semantik `--schema` per Dialect (Schema Semantics)
