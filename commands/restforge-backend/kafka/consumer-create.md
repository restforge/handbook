...
> Generate Kafka consumer code dari file payload JSON. Output berupa source code di `src/consumers/<project>/<name>/` yang nantinya dijalankan oleh binary `restforge-consumer`.
...
**Lihat juga**: [`kafka/`](./) · [`commands/`](../) · [`binary consumer`](../internal-binary.md) · [`README`](../../../README.md)
