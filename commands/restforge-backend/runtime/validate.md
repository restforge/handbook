...
Apabila target database (`DB_NAME`) belum ada pada server PostgreSQL atau MySQL, command `validate` akan secara otomatis menawarkan pembuatan database. Pemilihan jalur ditentukan oleh konteks eksekusi:
...
**Lihat juga**: [`runtime/`](./) · [`runtime/troubleshooting`](troubleshooting.md) · [`schema/migrate`](../schema/migrate.md) · [`commands/`](../) · [`README`](../../../README.md)
