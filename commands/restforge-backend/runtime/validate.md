...
| `--auto-create-db` | Tidak | `false` | Khusus postgres/mysql: otomatis buat database jika belum ada (skip konfirmasi). Berguna untuk CI/CD dan Docker. Tidak berlaku untuk sqlite/oracle |
