...
Kedua folder berisi dokumentasi binary terpisah. Pattern command berbeda di setiap binary — detail dibahas di section masing-masing.

## Perintah Operasi Backend

Pattern: `npx restforge <resource> <verb> [options]`. Total **40 public command** (4 runtime server + 1 verb global + 35 CLI generator) dan **2 internal binary**.
